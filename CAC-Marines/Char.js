class Character{
    constructor(){
        ...
        this.CanShoot = true;
        this.CanShootTimer = 100;

        this.Ammo0 = new Image();
        this.Ammo0.src = "art/FilledBullet3.png";
        this.Ammo1 = new Image();
        this.Ammo1.src = "art/FilledBullet2.png";
        this.Ammo2 = new Image();
        this.Ammo2.src = "art/FilledBullet1.png";
        this.Ammo3 = new Image();
        this.Ammo3.src = "art/FilledBullet0.png";
    ...
    Logic(){
        ...
        if(this.CanShoot == false){
            //change 1 to affect timer
            this.CanShootTimer -= 1;
    ...
    DrawReload(){
        //
        if(!this.CanShoot){
            if(this.CanShootTimer > 66){
                ctx.drawImage(this.Ammo0, 410, 540, 27, 33);
            }
            else if(this.CanShootTimer > 33){
                ctx.drawImage(this.Ammo1, 410, 540, 27, 33);
            }
            else if(this.CanShootTimer > 0){
                ctx.drawImage(this.Ammo2, 410, 540, 27, 33);
            }
        }
        else{   
